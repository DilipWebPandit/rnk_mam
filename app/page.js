...
const Icon = {
  ...
  Trademark: () => (
    <svg viewBox="0 0 24 24" fill="none" className="w-7 h-7" stroke="currentColor" strokeWidth={1.6}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.568 3H5.25A2.25 2.25 0 0 0 3 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.33a18.095 18.095 0 0 0 5.223-5.223c.542-.827.369-1.908-.33-2.607L9.568 3Z" /><path strokeLinecap="round" strokeLinejoin="round" d="M6 6h.008v.008H6V6Z" />
    </svg>
  ),
  Commercial: () => (
    <svg viewBox="0 0 24 24" fill="none" className="w-7 h-7" stroke="currentColor" strokeWidth={1.6}>
  ...
  Check: () => (
    <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5 shrink-0" stroke="currentColor" strokeWidth={2.2}>
...
function Hero() {
  const stats = [
    { value: "980",      label: "Patents filed in FY 2025-2026",                       delay: "delay-200" },
    { value: "≈ 1,400",  label: "Total patents filed by RNK Legalheads LLP",           delay: "delay-300" },
    { value: "≈ 180",    label: "Granted patents through RNK practice",                delay: "delay-400" },
    { value: "≈ 93%",    label: "Grant conversion from 193 hearing-completed matters", delay: "delay-500" },
  ];
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-16 items-center w-full">
        ...
        <div>
          ...
          <h1 className="animate-fade-up mb-2">
            <span
              ...
              style={{ fontFamily: "'Playfair Display', serif", textShadow: "0 2px 30px rgba(37,99,235,0.3)" }}
            >
              Proposal &amp;
            </span>
            <span
          ...
          <p className="text-slate-400 leading-relaxed max-w-lg mb-10 animate-fade-up delay-300">
            RNK Legalheads LLP advises on patents, designs, trademarks, and allied commercial
            matters — offering Eva Ad Ventures a single coordinated legal interface for full
            IP lifecycle support.
          </p>
          ...
          >
            <p className="text-slate-400 text-sm">
              <span className="text-white font-semibold">Financial Year 2025-2026</span>
              &nbsp;·&nbsp; Prepared by RNK Legalheads LLP &nbsp;·&nbsp; April 2026
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          {stats.map((s) => (
            <StatCard key={s.value} value={s.value} label={s.label} delay={s.delay} />
          ))}
          <div
            style={glassNote}
          ...
          >
            <p className="text-slate-400 text-xs italic text-center">
              Figures are based on information shared by RNK Legalheads LLP and are approximate where indicated.
            </p>
          </div>
        </div>
      </div>
      ...
      <div style={ribbonStyle} className="relative">
        <div className="max-w-7xl mx-auto px-6 py-4 flex flex-wrap gap-4 justify-center">
          {["Patents", "Designs", "Trademarks", "Commercial Matters", "In-House Compliance Support"].map(
            (item, i, arr) => (
              <span key={item} className="flex items-center gap-4">
                <span className="text-sm font-semibold text-slate-300 tracking-wide">{item}</span>
                {i < arr.length - 1 && (
                  <span
    ...
    <section className="bg-white py-24" id="executive">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-black text-slate-900 mt-2" style={{ fontFamily: "'Playfair Display', serif" }}>
            A focused legal partner for<br />
            <span className="text-gradient-blue">innovation-led growth</span>
          </h2>
          <p className="text-slate-500 mt-5 max-w-2xl mx-auto text-lg">
            RNK Legalheads LLP combines filing depth, prosecution experience, technical breadth,
            and practical commercial support in one coordinated interface.
          </p>
        </div>
        ...
        <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-blue-900 via-blue-800 to-indigo-900 p-8 md:p-10 mb-14 shadow-2xl">
          ...
          <div className="relative">
            <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-amber-400 text-sm font-bold tracking-wider uppercase">For Eva Ad Ventures Private Limited</p>
            </div>
            <p className="text-white text-lg leading-relaxed max-w-3xl">
              RNK can support the <span className="text-amber-300 font-semibold">full legal cycle</span> around
              innovation and brand assets — from patent drafting, filing, and prosecution to design and trademark
              protection, commercial documentation, and compliance-led support.
            </p>
          </div>
        </div>
            ...
            {pillars.map((p) => (
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-bold text-slate-900 text-lg mb-1">{p.title}</p>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {areas.map((a) => (
            ...
            >
              <div className={`practice-icon w-14 h-14 rounded-2xl bg-linear-to-br ${a.color} flex items-center justify-center text-white mb-5 shadow-lg`}>
                <a.Icon />
              </div>
              <div className={`text-xs font-bold tracking-widest uppercase mb-2 bg-linear-to-r ${a.color} text-transparent bg-clip-text`}>
                {a.tag}
              </div>
              <h3 className="font-black text-slate-900 text-xl mb-3">{a.title}</h3>
              <p className="text-slate-500 text-sm leading-relaxed flex-1">{a.desc}</p>
              <div className={`practice-bar mt-5 h-1 rounded-full bg-linear-to-r ${a.color} opacity-40`} />
            </div>
          ))}
        </div>
      </div>
    ...
    <section className="py-24 bg-white" id="technology">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-black text-slate-900 mt-2" style={{ fontFamily: "'Playfair Display', serif" }}>
            Work across all sciences<br />and engineering
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {techs.map((t) => (
            ...
            >
              <div className={`tech-stripe bg-linear-to-r ${t.gradient} w-full`} />
              <div className="p-8">
                <div className={`tech-icon w-16 h-16 rounded-2xl bg-linear-to-br ${t.gradient} flex items-center justify-center text-white mb-6 shadow-lg`}>
                  <t.Icon />
                </div>
                <div className={`inline-block text-xs font-black tracking-widest uppercase mb-3 bg-linear-to-r ${t.gradient} text-transparent bg-clip-text`}>
                  {t.stat}
                </div>
                <h3 className="font-black text-slate-900 text-xl mb-3 leading-snug">{t.title}</h3>
...
function ProsecutionStrength() {
  const steps = [
    { num: "01", title: "Assess",    desc: "Invention capture, initial review, and filing roadmap." },
    { num: "02", title: "File",      desc: "Drafting and structured filing for patents, designs, and marks." },
    { num: "03", title: "Prosecute", desc: "Responses, hearings, follow-up, and grant support." },
    { num: "04", title: "Support",   desc: "Agreements, documentation, and compliance-led advisory." },
  ];
  ...
  return (
    <section
      ...
      style={{ background: "linear-gradient(160deg, #060e24 0%, #0b1f4a 50%, #0e2a6a 100%)" }}
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="h-3 rounded-full overflow-hidden" style={{ background: "rgba(255,255,255,0.1)" }}>
            <div className="progress-bar h-full rounded-full" style={{ width: "93%" }} />
          </div>
          <p className="text-slate-400 text-xs mt-3">Based on 193 hearing-completed prosecutions</p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          >
            <p className="text-slate-300 leading-relaxed">
              RNK&apos;s portfolio strength is not limited to filing volume. Approximately{" "}
              <span className="text-white font-semibold">193 patent matters</span> have been prosecuted
              through hearing completion, of which approximately{" "}
              <span className="text-amber-300 font-semibold">180 have resulted in grant</span>.
              The balance remains under prosecution and pending before the Indian Patent Office.
            </p>
          </div>
          <div>
            <h3 className="text-amber-400 font-bold text-lg mb-5">Why clients engage RNK</h3>
            <div className="space-y-4">
              {reasons.map((r) => (
                <div key={r} className="flex gap-4">
                  <div className="mt-0.5 w-6 h-6 rounded-full bg-amber-400/20 border border-amber-400/40 flex items-center justify-center shrink-0">
                    <span className="text-amber-400"><Icon.Check /></span>
                  </div>
    ...
    <section className="py-24 bg-slate-50" id="clients">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-black text-slate-900 mt-2" style={{ fontFamily: "'Playfair Display', serif" }}>
            Trusted by institutions, research<br />ecosystems, and enterprises
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-10">
          ...
          <div className="client-card academic bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
            <div className="bg-linear-to-br from-blue-900 to-indigo-900 px-6 py-5">
              <p className="text-white font-bold text-lg">Academic &amp; Research Institutions</p>
              <p className="text-blue-200 text-sm mt-1">{academic.length} Premier Institutions</p>
            </div>
            <div className="p-4 space-y-1">
              {academic.map((c) => (
                <div key={c} className="client-row flex items-center gap-3 text-sm text-slate-700">
          ...
          <div className="client-card enterprise bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
            <div className="bg-linear-to-br from-amber-600 to-orange-700 px-6 py-5">
              <p className="text-white font-bold text-lg">Industry &amp; Enterprise Clients</p>
              <p className="text-amber-100 text-sm mt-1">{enterprise.length} Corporate Clients</p>
            </div>
            <div className="p-4 space-y-1">
              {enterprise.map((c) => (
                <div key={c} className="client-row flex items-center gap-3 text-sm text-slate-700">
        ...
        <div className="bg-linear-to-r from-blue-50 to-indigo-50 border border-blue-100 rounded-2xl px-8 py-5 text-slate-600 italic text-center">
          RNK&apos;s client base reflects work across premier educational institutions, research-led ecosystems,
          and private enterprises with diverse innovation and brand protection requirements.
        </div>
      </div>
    </section>
  );
    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-black text-slate-900 mt-2" style={{ fontFamily: "'Playfair Display', serif" }}>
            A practical support structure aligned<br />to growth, protection, and readiness
          </h2>
        </div>
            ...
            <div className="space-y-2">
              {supports.map((s, i) => (
                <div key={i} className="support-row flex gap-4 p-3">
                  ...
                  <p className="text-slate-600 text-sm leading-relaxed pt-1">{s}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className="rounded-3xl overflow-hidden border border-slate-100 shadow-sm flex-1">
              <div className="bg-linear-to-br from-blue-900 to-indigo-900 p-6">
                <p className="text-white font-bold text-xl">What Eva Ad Ventures can expect</p>
                <p className="text-blue-200 text-sm mt-1">Our commitment to you</p>
              </div>
        ...
        <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-blue-900 via-blue-800 to-indigo-900 p-10 text-center shadow-2xl">
          ...
          <p className="text-amber-400 text-sm font-bold tracking-widest uppercase mb-4">Long-term Partnership</p>
          <p className="text-white text-xl md:text-2xl font-bold leading-relaxed max-w-3xl mx-auto mb-8" style={{ fontFamily: "'Playfair Display', serif" }}>
            RNK Legalheads LLP is positioned to serve as a long-term legal partner for Eva Ad Ventures Private Limited
            across present and future IP, documentation, and compliance requirements.
          </p>
          <a
            href="mailto:contact@rnklegalheads.com"
...
function Footer() {
  return (
    <footer
      style={{ background: "linear-gradient(160deg, #071328 0%, #0b1f4a 100%)" }}
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-12 pb-12 border-b border-white/10">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-6">
              Built on Trust, Driven by Commitment. A leading IP and commercial legal firm
              serving institutions, research ecosystems, and enterprises across India.
            </p>
            <p className="text-amber-400 italic font-semibold" style={{ fontFamily: "'Playfair Display', serif" }}>
              &ldquo;Built on Trust, Driven by Commitment.&rdquo;
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["Patents", "Designs", "Trademarks", "Commercial Matters", "In-House Compliance"].map((s) => (
                <li key={s} className="flex items-center gap-2 text-slate-400 text-sm hover:text-amber-400 transition-colors cursor-pointer">
                  <span className="w-1 h-1 rounded-full bg-amber-400/50" />{s}
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <a href="mailto:contact@rnklegalheads.com" className="flex items-start gap-3 text-slate-400 text-sm hover:text-amber-400 transition-colors group">
                <span className="mt-0.5 text-amber-400 group-hover:scale-110 transition-transform"><Icon.Mail /></span>
                contact@rnklegalheads.com
              </a>
              <div className="flex items-start gap-3 text-slate-400 text-sm">
                <span className="mt-0.5 text-amber-400 shrink-0"><Icon.Phone /></span>
                +91 9779202789 | +91 6003416196
              </div>
              <div className="flex items-start gap-3 text-slate-400 text-sm">
                <span className="mt-0.5 text-amber-400 shrink-0"><Icon.Location /></span>
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-slate-500 text-xs">
            Confidential | Prepared exclusively for Eva Ad Ventures Private Limited
          </p>
          <p className="text-slate-500 text-xs">
